...
// namespace lux_bb // lux_but_better
// {
...
// namespace detail {
// 	// Some namespace trickery here
// 	struct Add{
//       template<typename A, typename B>
//       static auto apply(const A& a, const B& b) -> decltype(a + b) {
//          return a + b
//       }
//    };
// 	struct Multiply{};
...
// template <typename T>
// class Field : public Volume<T>
// {
//   using Base = std::shared_ptr<Volume<T>>
//   public:
...
//     // Now we can define the operator overloads per class because who could really 
//     // be bothered to do those operator overloads four times?
//    //  template<typename L, typename R>
//    //  Field<typename detail::FieldResult<L, R, detail::Add>::type> operator+(
//    //  const Field<L>
//    //)
// };

// template<typename T>
// using Field_sp = std::shared_ptr<Field<T>>;
